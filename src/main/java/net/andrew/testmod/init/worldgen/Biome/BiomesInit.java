...
public static final RegistryKey<Biome> CRYSTAL_BIOME = RegistryKey.of(RegistryKeys.BIOME,
    ...
    public static final RegistryKey<Biome> ORC_PLAINS = RegistryKey.of(RegistryKeys.BIOME,
            Identifier.of(TestMod.MOD_ID, "crystal_biome"));


public static void boostrap(Registerable<Biome> context) {
    context.register(CRYSTAL_BIOME, crystalbiome(context));
...
public static Biome crystalbiome(Registerable<Biome> context) {
