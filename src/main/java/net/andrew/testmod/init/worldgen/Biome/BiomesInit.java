...
public class BiomesInit {
    public static final RegistryKey<Biome> HOBBIT_BIOME = RegistryKey.of(RegistryKeys.BIOME,
            Identifier.of(TestMod.MOD_ID, "hobbit_biome"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(HOBBIT_BIOME, testBiome(context));
    }
